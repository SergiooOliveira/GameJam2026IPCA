using UnityEngine;
using UnityEngine.InputSystem; // Mantido caso use para outras a��es (como atacar/interagir)
...
public class PlayerMovement : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        // Criamos a dire��o com base no input (seja do Joystick ou do Input System)
        Vector3 inputDirection = new Vector3(movementX, 0f, movementY).normalized;

        // Se o joystick se mover quase nada, evitamos rota��es fantasmas
        ...
        {
            // 1. Rotaciona o jogador na dire��o do input
        ...
        // 3. Move exatamente para onde o jogador est� olhando (Garante o U-Turn)
    ...
    // Mantido caso voc� ainda queira testar no PC usando o teclado pelo New Input System
    public void OnMove(InputAction.CallbackContext callbackContext)
    {
        if (joystick == null) // S� usa o Input System se N�O houver joystick na tela
        {
